...
@section('title')harotoko｜チケット登録 @endsection
...
<div class="container">
    ...
    <div class="col-md-6 mx-auto">
        ...
        <form method="POST"  class="h-adr" action="{{ route('ticket.store') }}" enctype="multipart/form-data" onsubmit="return submitChk()">
        @csrf
        <div class="mx-auto">
            <div class='row'>
                ...
                <div class='form-group col-md-6'>
                    ...
                    <select id='remaing' class='form-control' name = 'type'>
