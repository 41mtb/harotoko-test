...
<div class="container">
    ...
    <div class="col-md-6 mx-auto">
        ...
        <form method="POST"  class="h-adr" action="{{ route('profile.store') }}" enctype="multipart/form-data" onsubmit="return submitChk()">
        @csrf
        <input id="user_id" type="hidden" name = "user_id" value="{{ $user['id'] }}">
            <div class='row'>
                <div class="form-group col-md-6">
                    <input id="real_name" placeholder='本名' type="text" class="form-control fform-control-sm" name = "real_name" value="{{ old('real_name') }}">
                </div>
                <div class="form-group col-md-6">
                    <input type="text" class="form-control fform-control-sm" placeholder="生年月日" name = "birthday" value="{{ old('birthday') }}">
                </div>
            </div>
            <div class='row'>
                <div class="form-group col-md-6"> 
