...
<div class="container">
    ...
    <div class="col-md-6 mx-auto">
        <div class="text-center card-header my-3">
            <span class="h5 font-weight-bold">店舗編集<span>
        </div>
        <form method="POST"  class="h-adr" action="{{ route('shop.update', ['shop' => $shop->id ] ) }}" enctype="multipart/form-data" onsubmit="return submitChk()">
        @csrf
        @method('PUT')
        <div class="mx-auto">
            ...
            <div class='row'>
                <div class="form-group col-md-6">
                    <input id="shop_name" placeholder='店舗名' type="text" class="form-control fform-control-sm" name = "shop_name" value="{{ $shop->shop_name }}">
                </div>
                <div class="form-group col-md-6">
                    <input type="text" class="form-control fform-control-sm" placeholder="代表者名" name = "name" value="{{ $shop->name }}">
                </div>
            </div>
            <div class='row'>
            ...
            <div class='row'>
                ...
                <div class="form-group col-md-6">
                    <input type="text" class="form-control fform-control-sm" placeholder="メールアドレス" name = "email" value="{{ $shop->email }}">
                </div>
            </div>
            <div class='row'>
                <div class="form-group col-md-6">
                    <input type="text" class="form-control fform-control-sm" placeholder="携帯電話番号" name = "mobile" value="{{ $shop->mobile }}">
                </div>
                <div class="form-group col-md-6">
                    <input type="text" placeholder="電話番号"  class="form-control fform-control-sm" name = "phone" value="{{ $shop->phone }}">
                </div>
            </div>
            <div class='row'>
                <div class="form-group col-md-6"> 
                    <span class="p-country-name" style="display:none;">Japan</span>
                    <input type="text" class="form-control fform-control-sm p-postal-code" placeholder="郵便番号"  size="8" maxlength="8" name = "postcode" value="{{ $shop->postcode }}">
                </div>
                <div class="form-group col-md-6">
                    <input type="text" placeholder="住所（都道府県）"  class="p-region form-control fform-control-sm" name = "prefecture" value="{{ $shop->prefecture }}">
                </div>
            </div>
            <div class='row'>
                <div class="form-group col-md-6">
                    <input  type="text" class="form-control fform-control-sm p-locality p-street-address" placeholder="住所（市区町村）" name = "city" value="{{ $shop->city}}">
                </div>
                <div class="form-group col-md-6">
            ...
            <div class='row'>
                ...
                <div class="form-group col-md-9">
                    <textarea id="ad_characteristic" type="textarea" class="form-control fform-control-sm" rows="4" placeholder="チェーン店と比較し、メニューの価格は少し高め。30代女性が主な顧客で、ランチやパーティー会場としてよく使われている。" name = "description">{{ $shop->description }}</textarea>
                </div>
            </div>
